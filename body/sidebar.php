<aside class="main-sidebar elevation-4" style="background-color: #F4F481;">
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../images/Avatar1.png" class="img-circle elevation-2" style="width: 60px; height: 60px;">
        </div>
        <div class="info">
          <a href="profile.php" class="d-block" style="color: BLACK;"><h2><?php 
          // $sqlFirstname = $fetchUsers["users_account_id"];

          $sqlAccount = "SELECT account_firstname FROM account_tbl WHERE account_users_id = $_SESSION[users_id]";
          $queryAccount = mysqli_query($dbConString, $sqlAccount);
          $fetchAccount = mysqli_fetch_assoc($queryAccount);

          print $fetchAccount["account_firstname"]?></h2></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="dashboard.php" class="nav-link active" style="background-color: BLACK;">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="accounts.php" class="nav-link" style="color: BLACK;">
                  <i class="far fa-circle nav-icon" style="color: BLACK;"></i>
                  <p style="color: BLACK;">Owners</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-cog" style="color: BLACK;"></i>
              <p style="color: BLACK;">
                Settings
                <i class="fas fa-angle-left right" style="color: BLACK;"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../samjang/users.php" class="nav-link" style="color: BLACK;">
                  <i class="far fa-circle nav-icon" style="color: BLACK;"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="page-manager.php" class="nav-link" style="color: BLACK;">
                  <i class="far fa-circle nav-icon" style="color: BLACK;"></i>
                  <p style="color: BLACK;">Page Management</p>
                </a>
              </li>
            </ul>
          </li>
