<?php
  ...
  if(isset($_POST['btnSave'])) {
    $txtAccountFirstName = $_POST['Firstname'];
    $txtAccountMiddleName = $_POST['Middlename'];
    $txtAccountLastName = $_POST['Lastname'];
    $txtAccountEmail = $_POST['Email'];
    $txtAccountContact = $_POST['Contact'];
    $txtAccountBirthday = $_POST['Birthday'];
    $txtAccountAddress = $_POST['Address'];
    $date = date('Y-m-d');
    
    $img = $_FILES["fileUpload"]["name"];
    
    $sqlAddAccount = "INSERT INTO account_tbl() VALUES (NULL, '', '', '$txtAccountFirstName', '$txtAccountMiddleName', '$txtAccountLastName', 
    '$txtAccountEmail', '$txtAccountContact', '$txtAccountBirthday', '$txtAccountAddress', '$img', 0)";
            ...
            <div class="card card-primary">
              ...
              <form method="post" role="form" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                  <label for="exampleInputMiddleEmail">Middle Name</label>
                    <input type="text" class="form-control" id="exampleInputMiddleEmail" name="Middlename" placeholder="Middle Name">
                  </div>
                  <div class="form-group">
                  ...
                  <label for="exampleBirthday">Birthday</label>
                    <input type="date" class="form-control" id="exampleBirthday" name="Birthday" placeholder="Birthday">
                  </div>
                  <div class="form-group">
