<?php
  ...
  $id = $_GET['id'];
  $sqlBranches = "SELECT * FROM branches_tbl WHERE branch_id = $id";
  $queryBranches = mysqli_query($dbConString, $sqlBranches);
  $fetchBranches = mysqli_fetch_assoc($queryBranches);
              ...
              <form method="post" role="form" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleBranchName" name="Branchname" value="<?php print $fetchBranches['branch_name']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputBranchEmail">Branch Email</label>
                    <input type="email" class="form-control" id="exampleInputBranchEmail" name="Email" value="<?php print $fetchBranches['branch_email']; ?>">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputBranchContact">Branch Contact Number</label>
                    <input type="text" class="form-control" id="exampleInputContact" name="Contact" value="<?php print $fetchBranches['branch_contact']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAddress">Branch Address</label>
                    <input type="text" class="form-control" id="exampleInputAddress" name="Address" value="<?php print $fetchBranches['branch_address']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleEstablish">Establish</label>
                    <input type="date" class="form-control" id="exampleEstablish" name="Establish" value="<?php print $fetchBranches['branch_establish']; ?>">
                  </div>
                </div>
                <!-- /.card-body -->
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="text-center">
                      <img src="upload/<?php print $fetchBranches["branch_image"]?>" class="img-circle elevation-2" style="width: 180px; height: 180px;">
                    </div>
                    <br>
                    <br>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="exampleInputFile" name="fileUpload" value="<?php print $fetchBranches['branch_image']; ?>">
