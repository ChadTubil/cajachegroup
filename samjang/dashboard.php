        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon elevation-1" style="background-color: #F4F481;">
                <img src="../images/Samjang_Logo.png" alt="Samjang Logo" style="width: 60%;">
              </span>
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php
                    $sqlBranch = "SELECT branch_name FROM branches_tbl ORDER BY branch_id DESC LIMIT 1";
                    $queryBranch = mysqli_query($dbConString, $sqlBranch);
                    $fetchBranch = mysqli_fetch_assoc($queryBranch);
                    
                    echo $fetchBranch["branch_name"];
                  ?>
                </span>
              </div>
              <!-- /.info-box-content -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">No. of Branches</span>
                <span class="info-box-number">
                  <?php
                    $sqlBranch2 = "SELECT COUNT(branch_id) AS TotalBranch FROM branches_tbl WHERE branch_isdel=0;";
                    $queryBranch2 = mysqli_query($dbConString, $sqlBranch2);
                    $fetchBranch2 = mysqli_fetch_assoc($queryBranch2);
                    
                    echo $fetchBranch2["TotalBranch"];
                  ?>
                </span>
              </div>
              <!-- /.info-box-content -->
