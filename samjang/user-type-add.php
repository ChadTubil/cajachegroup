<?php
  ...
  if(isset($_POST['btnSave'])) {
    ...
    $sqlAddUserType = "INSERT INTO user_type_tbl() VALUES (NULL, '$txtUserType', '$txtUserDescription', '$date', 0)";
    mysqli_query($dbConString, $sqlAddUserType);
              ...
              <form method="post" role="form" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputAccountType" name="Accounttype" placeholder="Account Type">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAccountEmail">Description</label>
                    <input type="text" class="form-control" id="exampleInputAccountDescription" name="Accountdescription" placeholder="Description">
                  </div>
                </div>
                <!-- /.card-body -->
